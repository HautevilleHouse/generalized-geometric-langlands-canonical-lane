...
mkdir -p .codex_tmp/generalized_geometric_langlands
cp artifacts/stitch_constants.json .codex_tmp/generalized_geometric_langlands/stitch_constants.json
cp artifacts/constants_registry.json .codex_tmp/generalized_geometric_langlands/constants_registry.json
